...
* **$** match a *position*, corresponding to the end of the target string; ^dog$ match the beginning of a string followed by dog followed by the end of the string; $^match an empty line
